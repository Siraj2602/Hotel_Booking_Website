<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $S = "$hotels[1]\;$checkin\;$checkout\;$adults\;$children\;";
        ...
        $sql = "SELECT rooms FROM Hotels.no WHERE id=1";
...
$rooms = $rooms -1;
    ...
    $sql = "UPDATE Hotels.no SET rooms = $rooms WHERE id=1";
